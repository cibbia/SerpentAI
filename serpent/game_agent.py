...
class GameAgent(offshoot.Pluggable):
    ...
    def __init__(self, **kwargs):
        ...
        # Dynamically look for a custom reward function module generated by the GUI
        import importlib
        plugin_module_name = f"plugins.games.{self.game.__class__.__name__}Plugin.reward"
        try:
            reward_mod = importlib.import_module(plugin_module_name)
            if hasattr(reward_mod, "reward"):
                self.reward_functions["CUSTOM"] = reward_mod.reward
